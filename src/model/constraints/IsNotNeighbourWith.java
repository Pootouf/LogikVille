...
/**
 * Quatrième type de contrainte pouvant être rencontré dans les cartes.
 * Impose que l'entité E et F ne soient pas voisines.
 * 
 * @inv <pre>
...
public class IsNotNeighbourWith<E extends Entity, F extends Entity> extends Constraint {
	...
	public IsNotNeighbourWith(House[] maisons, Entity e, Entity f) {
		super(maisons);
